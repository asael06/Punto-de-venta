...
namespace Punto_de_venta.Clases
{
    ...
    public class RawPrinterHelper
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
        {
            ...
            di.pDocName = "Ticket de Venta " + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + "  " + DateTime.Now.Hour + "_" + DateTime.Now.Minute + "_" + DateTime.Now.Second;//Este es el nombre con el que guarda el archivo en caso de no imprimir a la impresora fisica.            
